...
revenueController.$inject = ['revenueService', 'Flash', '$scope'];
function revenueController(revenueService, Flash, $scope) {
  var vm = this;
  ...
  $scope.setTab = function(newTab){
    ...
    revenueService.getStatistic(params)
    .then(function(resp){
